...
export default function MenuPage() {
  ...
  return (
    <main className="min-h-screen bg-[var(--cream)] text-[var(--black)] font-playfair pb-20">
      
      {/* Hero Section */}
      <section className="relative h-[40vh] flex items-center justify-center bg-[var(--red-dark)] text-[var(--white)]">
        <div className="absolute inset-0 bg-gradient-to-b from-[var(--red-dark)]/70 to-[var(--black)]/50" />
