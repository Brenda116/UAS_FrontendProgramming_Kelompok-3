...
export default function OurHistoryPage() {
  ...
  return (
    <main className="min-h-screen bg-[var(--cream)] text-[var(--black)]">
    {/* Hero */}
    ...
    <h2 className="text-4xl md:text-5xl font-[var(--font-playfair)] font-semibold text-[var(--red-dark)] text-right">
    ...
    {/* History Card */}
    <section className="flex flex-col md:flex-row bg-[var(--white)] shadow-lg rounded-4xl overflow-hidden mx-auto my-16 max-w-screen-2xl h-auto md:h-[650px]">
    {/* Gambar */}
    ...
    <section className="max-w-screen-2xl mx-auto mt-20 px-6 md:px-16">
    <h2 className="text-4xl md:text-5xl font-[var(--font-playfair)] font-semibold text-[var(--red-dark)] text-left">
    ...
    {/* Founder 01 */}
    <section className="flex flex-col md:flex-row bg-[var(--white)] shadow-lg rounded-4xl overflow-hidden mx-auto my-20 max-w-screen-2xl h-auto md:h-[600px]">
    {/* Gambar */}
    <div className="w-full md:w-1/2">
    <img
        src="/images/Founder01.jpg"
        alt="Foundera of Notte Azzura"
    ...
    {/* Founder 2 */}
    <section className="flex flex-col md:flex-row-reverse bg-[var(--white)] shadow-lg rounded-4xl overflow-hidden mx-auto my-16 max-w-screen-2xl h-auto md:h-[600px]">
    {/* Gambar */}
    <div className="w-full md:w-1/2">
    <img
    ...
    <p className="text-left text-lg md:text-xl text-[var(--gray-dark)] mt-2">
    ...
    {/* Slider */}
    <div className="mt-12 flex overflow-x-auto space-x-6 pb-6 scroll-smooth snap-x snap-mandatory no-scrollbar">
    {[
        { year: 1985, 
